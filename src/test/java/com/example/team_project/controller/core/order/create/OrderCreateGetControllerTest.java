...
class OrderCreateGetControllerTest {
    ...
    @Autowired
    OrderCreateGetControllerTest(OrderCreateController orderCreateController, UserRepository userRepository, UserAddressRepository userAddressRepository, PaymentRepository paymentRepository, SellerRepository sellerRepository, OrderRepository orderRepository, ProductRepository productRepository, OrderCreateService orderCreateService, OrderListRepository orderListRepository, ProductCategoryRepository productCategoryRepository, UserLoginInterceptor userLoginInterceptor, ControllersAdvice controllersAdvice) {
    ...
    void 주문_추가_정상작동() throws Exception {
        ...
        OrderList orderList = new OrderList(user, payment);
