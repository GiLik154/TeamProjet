...
class CouponUpdateServiceImplTest {
    ...
    @Autowired
    CouponUpdateServiceImplTest(CouponKindsUpdateService couponKindsDeleteService, CouponRepository couponRepository) {
    ...
    void 쿠폰종류_정보_수정_할인율1() {
        Coupon coupon = new Coupon("testName", 50, 10000);
        couponRepository.save(coupon);

        CouponUpdateServiceDto couponUpdateServiceDto = new CouponUpdateServiceDto(1, 9999);
    ...
    void 쿠폰종류_정보_수정_할인율99() {
        ...
        CouponUpdateServiceDto couponUpdateServiceDto = new CouponUpdateServiceDto(99, 9999);
    ...
    void 쿠폰종류_정보_수정_최소구매_1() {
        ...
        CouponUpdateServiceDto couponUpdateServiceDto = new CouponUpdateServiceDto(50, 1);
    ...
    void 쿠폰종류_정보_수정_할인율_0미만() {
        ...
        CouponUpdateServiceDto couponUpdateServiceDto = new CouponUpdateServiceDto(0, 9999);
    ...
    void 쿠폰종류_정보_수정_할인율_100이상() {
        ...
        CouponUpdateServiceDto couponUpdateServiceDto = new CouponUpdateServiceDto(100, 9999);
    ...
    void 쿠폰종류_정보_수정_최소구매_0이하() {
        ...
        CouponUpdateServiceDto couponUpdateServiceDto = new CouponUpdateServiceDto(50, 0);
